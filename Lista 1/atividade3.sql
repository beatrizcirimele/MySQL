...
value ("Daniel Coelho",15,"2ºA",7.3);
insert into tb_estudantes (nome,idade,ano,media)
value ("Michelle Melo",16,"2ºA",9.2);
insert into tb_estudantes (nome,idade,ano,media)
value ("Kelly Key",15,"2ºB",8.6);
insert into tb_estudantes (nome,idade,ano,media)
value ("Jim Morrison",13,"1ºA",5.8);
insert into tb_estudantes (nome,idade,ano,media)
value ("Jim Halpert",15,"2ºB",7.8);
insert into tb_estudantes (nome,idade,ano,media)
value ("Erin Hannon ",14,"2ºC",6.3);
insert into tb_estudantes (nome,idade,ano,media)
value ("Arthur Galhardo",17,"3ºA",7.0);
insert into tb_estudantes (nome,idade,ano,media)
value ("Michael Jackson",16,"1ºA",3.2);
